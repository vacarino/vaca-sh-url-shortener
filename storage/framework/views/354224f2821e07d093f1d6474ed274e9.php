     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Create Short URL')); ?>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <?php if(session('short_url')): ?>
                                <div class="mt-4 p-4 bg-white dark:bg-gray-800 rounded-lg border border-green-200 dark:border-green-700">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <input type="text" value="<?php echo e(session('short_url')); ?>" readonly 
                                                ...
                                                <button onclick="copyToClipboard('<?php echo e(session('short_url')); ?>')" 
                                    ...
                                    <div class="mt-4 flex items-center justify-between">
                                        <div class="flex-1">
                                            <div id="qrcode-<?php echo e(session('short_code')); ?>" class="inline-block p-2 bg-white rounded-lg"></div>
                                        </div>
                                        <div class="text-right">
                                            <button onclick="downloadQR('<?php echo e(session('short_url')); ?>', '<?php echo e(session('short_code')); ?>')" 
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <!-- Form -->
                <form method="POST" action="<?php echo e(route('urls.store')); ?>" class="p-8 space-y-8" x-data="urlForm()">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="original_url" name="original_url" type="url" required 
                                   ...
                                   class="block w-full pl-10 pr-3 py-4 text-lg border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 <?php $__errorArgs = ['original_url'];
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="short_code" name="short_code" type="text"
                                   x-model="shortCode"
                                   value="<?php echo e(old('short_code')); ?>"
                                   class="block w-full pl-10 pr-3 py-4 text-lg border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 <?php $__errorArgs = ['short_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 dark:border-red-600 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div x-show="shortCode" class="mt-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                            <div class="flex items-center space-x-2">
                                ...
                                <code class="text-sm font-mono text-blue-600 dark:text-blue-400" x-text="'<?php echo e(request()->getSchemeAndHttpHost()); ?>/' + shortCode"></code>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function urlForm() {
            return {
                originalUrl: '<?php echo e(old("original_url")); ?>',
                shortCode: '<?php echo e(old("short_code")); ?>'
            }
        }
        ...
        <?php if(session('short_url')): ?>
            document.addEventListener('DOMContentLoaded', function() {
                QRCode.toCanvas(document.querySelector('#qrcode-<?php echo e(session('short_code')); ?>'), '<?php echo e(session('short_url')); ?>', {
                    width: 100,
                    height: 100,
                    color: {
                        dark: '#1F2937',
...
<?php endif; ?> <?php /**PATH /home/sky/Desktop/URL/url-shortener/resources/views/urls/create.blade.php ENDPATH**/ ?>