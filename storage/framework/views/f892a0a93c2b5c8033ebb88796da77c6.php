...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
            ...
            <a href="<?php echo e(route('urls.create')); ?>" class="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg">
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($shortUrls->totalUrls ?? $shortUrls->total())); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($shortUrls->totalClicks ?? 0)); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($shortUrls->activeUrls ?? 0)); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($shortUrls->thisMonthUrls ?? 0)); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <form method="GET" action="<?php echo e(route('urls.index')); ?>" class="space-y-6">
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <select id="sort" 
                                ...
                                <option value="clicks" <?php echo e(request('sort') == 'clicks' ? 'selected' : ''); ?>>Click Count</option>
                                <option value="short_code" <?php echo e(request('sort') == 'short_code' ? 'selected' : ''); ?>>Short Code</option>
                                <option value="original_url" <?php echo e(request('sort') == 'original_url' ? 'selected' : ''); ?>>Original URL</option>
                            </select>
                        </div>
                    ...
                    <?php if(request()->hasAny(['search', 'user_id', 'sort', 'direction'])): ?>
                        <div class="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                Active filters applied
                            </div>
                            <a href="<?php echo e(route('urls.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-all duration-200">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                </svg>
                                Clear All
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm text-blue-800 dark:text-blue-200">
                            Showing <?php echo e($shortUrls->firstItem()); ?> to <?php echo e($shortUrls->lastItem()); ?> of <?php echo e(number_format($shortUrls->total())); ?> URLs
                            <?php if(request()->filled('search')): ?>
                                matching <strong>"<?php echo e(request('search')); ?>"</strong>
                            <?php endif; ?>
                            <?php if(auth()->user()->isAdmin() && request()->filled('user_id')): ?>
                                for <strong><?php echo e($users->firstWhere('id', request('user_id'))->name ?? 'Unknown User'); ?></strong>
                            <?php endif; ?>
                        </span>
                    </div>
                </div>
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex items-center space-x-3 mb-2">
                                                <code class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-mono bg-gray-100 dark:bg-gray-700 text-blue-600 dark:text-blue-400 font-semibold">
                                                    <?php echo e($shortUrl->short_code); ?>

                                                </code>
                                                <button 
                                                    onclick="copyToClipboard('<?php echo e($shortUrl->getShortUrl()); ?>')"
                                            ...
                                            <!-- Original URL -->
                                            <div class="mb-3">
                                                <a href="<?php echo e($shortUrl->original_url); ?>" target="_blank" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 break-all">
                                                    <?php echo e(strlen($shortUrl->original_url) > 80 ? substr($shortUrl->original_url, 0, 80) . '...' : $shortUrl->original_url); ?>
                                            ...
                                            <div class="flex flex-wrap items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                                                <div class="flex items-center">
                                                    ...
                                                    <strong class="text-gray-900 dark:text-white"><?php echo e(number_format($shortUrl->clicks)); ?></strong> clicks
                                                </div>
                                                    ...
                                                    <div class="flex items-center">
                                                        <div class="w-5 h-5 bg-gradient-to-br from-gray-500 to-gray-600 rounded-full flex items-center justify-center mr-2">
                                                            <span class="text-xs font-medium text-white">
                                                                <?php echo e(substr($shortUrl->user->name ?? 'U', 0, 1)); ?>

                                                            </span>
                                                        </div>
                                                        <?php echo e($shortUrl->user->name ?? 'Unknown User'); ?>
                                ...
                                <div class="flex items-center space-x-3 lg:ml-6">
                                    ...
                                    <?php if($shortUrl->clicks > 0): ?>
                                        <div class="hidden lg:block text-right">
                                            <div class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e(number_format($shortUrl->clicks)); ?></div>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <a href="<?php echo e(route('analytics.show', $shortUrl->short_code)); ?>" 
                                        ...
                                        <form method="POST" action="<?php echo e(route('short-urls.destroy', $shortUrl)); ?>" class="inline" onsubmit="return confirmDelete('<?php echo e($shortUrl->short_code); ?>', '<?php echo e($shortUrl->original_url); ?>')">
                                            <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
                    <?php if(request()->hasAny(['search', 'user_id'])): ?>
                        ...
                        <a href="<?php echo e(route('urls.index')); ?>" class="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-200">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                            </svg>
                            Clear All Filters
...
<?php endif; ?> <?php /**PATH /home/sky/Desktop/URL/url-shortener/resources/views/urls/index.blade.php ENDPATH**/ ?>