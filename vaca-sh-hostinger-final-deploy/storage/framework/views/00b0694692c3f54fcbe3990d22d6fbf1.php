...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="{ darkMode: localStorage.getItem('darkMode') === 'true' }" x-bind:class="{ 'dark': darkMode }">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Vaca.Sh')); ?> - Professional URL Shortener</title>
        ...
        <meta property="og:image" content="<?php echo e(asset('images/vaca-sh-og.png')); ?>">
        ...
        <meta name="twitter:image" content="<?php echo e(asset('images/vaca-sh-og.png')); ?>">
                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="flex items-center">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="hidden md:ml-8 md:flex md:space-x-8">
                                    <a href="<?php echo e(route('urls.index')); ?>" class="inline-flex items-center px-1 pt-1 text-sm font-medium <?php echo e(request()->routeIs('urls.*') ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                        </svg>
                                        Dashboard
                                    </a>
                                    <a href="<?php echo e(route('urls.create')); ?>" class="inline-flex items-center px-1 pt-1 text-sm font-medium <?php echo e(request()->routeIs('urls.create') ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    <button @click="open = !open" class="flex items-center space-x-2 text-sm rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                                        ...
                                        <span class="text-gray-700 dark:text-gray-300 font-medium"><?php echo e(Auth::user()->name); ?></span>
                                    ...
                                    <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50">
                                        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                                            <p class="text-sm text-gray-900 dark:text-gray-100 font-medium"><?php echo e(Auth::user()->name); ?></p>
                                        ...
                                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <?php else: ?>
                                <!-- Guest Navigation -->
                                <div class="flex items-center space-x-4">
                                    <a href="<?php echo e(route('login')); ?>" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 text-sm font-medium transition-colors duration-200">
                                        Sign In
                                    </a>
                                    <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-sm">
                                        Get Started
                                    </a>
                                </div>
                            <?php endif; ?>
                ...
                <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul class="space-y-2">
                                <li><a href="<?php echo e(route('home')); ?>" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 text-sm transition-colors duration-200">Features</a></li>
                                <li><a href="<?php echo e(route('urls.create')); ?>" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 text-sm transition-colors duration-200">Create Link</a></li>
                                <?php if(auth()->guard()->check()): ?>
                                    <li><a href="<?php echo e(route('urls.index')); ?>" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 text-sm transition-colors duration-200">Dashboard</a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    ...
                    <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 flex flex-col md:flex-row justify-between items-center">
                        <p class="text-gray-500 dark:text-gray-400 text-sm">
                            Vaca.Sh — v2.0 © <?php echo e(date('Y')); ?>. All rights reserved.
                        </p>
...
<?php /**PATH /home/sky/Desktop/URL/vaca-sh-deployment/resources/views/layouts/app.blade.php ENDPATH**/ ?>